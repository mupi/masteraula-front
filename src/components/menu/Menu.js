...
const Menu = (props) => {
  ...
  const loggedOptions =
    <Nav className="ml-auto" navbar>
      <NavItem><Link to="/question-base/1"><i className="fa fa-home"></i> Home</Link></NavItem>
          ...
          <Row>
              <Col xs="12">
                <Navbar id="masteraula-nav-header" className="navbar navbar-default navbar-fixed-top" color="primary" dark expand="md">
                  ...
                  <NavItem>
                    <Link exact="true" to="/">{isLoggedIn ? '':<img className="logo-in-menu no-login"  src={logoMasterAula} />}</Link>
                  </NavItem>
