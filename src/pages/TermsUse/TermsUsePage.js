  ...
  <div className="l-site-masteraula__public-home c-terms-use middle-box">
    <Container>
      ...
      <div className="c-terms-use__section">
        ...
        <p>
        A presente Política de Privacidade foi elaborada para reafirmar o compromisso da empresa responsável pela plataforma com a privacidade e a segurança das informações coletadas dos usuários que o acessam.
        </p>
        <p>
